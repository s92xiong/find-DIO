    ...
    <div className="game-start">
      <div className="game-start-modal">
        <div className="left-side-modal">
          ...
          <p>
            Help the Joestars find their enemy <span className="dio-span">DIO</span> and his two minions, <span className="ed-span">Edward Elric</span> and <span className="spike-span">Spike Spiegel</span>
          </p>
        </div>
        <div className="right-side-modal">
          <button onClick={startGame}>Start</button>
          <p className="artist">
            <a href="https://www.artstation.com/artwork/nQgAEK" target="blank">
